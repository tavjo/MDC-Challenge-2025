...
class BulkParseRequest(BaseModel):
    ...
    strategy: Optional[Literal["fast", "hi_res", "ocr_only"]] = "hi_res"
...
class ChunkingResult(BaseModel):
    ...
    total_tokens: Optional[int] = Field(None, description="Total number of tokens in all chunks.")
    avg_tokens_per_chunk: Optional[float] = Field(None, description="Average number of tokens per chunk.")
